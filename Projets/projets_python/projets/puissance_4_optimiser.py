...
# save/load c'est bon mais faut  que maitenant reafficher la save
...
def clic(event):
    global n1,n2,n3,n4,n5,n6,n7,liste_retour
    if 0 < event.x <100 :
        if n1  <  6 :
            canvas.itemconfigure(liste_matrice_objets[0][5-n1], fill = couleur)
            liste_retour.append(liste_matrice_objets[0][5-n1])
            if couleur == "red" :
    ...
    if 100< event.x <200 :
        if n2 < 6 :
            ...
            liste_retour.append(liste_matrice_objets[1][5-n2])
            if couleur == "red" :
    ...
    if 200< event.x <300 :
        if n3< 6 :
            ...
            liste_retour.append(liste_matrice_objets[2][5-n3])
            if couleur == "red" :
    ...
    if 300< event.x <400 :
        if n4 < 6 :
            ...
            liste_retour.append(liste_matrice_objets[3][5-n4])
            if couleur == "red" :
    ...
    if  400< event.x <500 :
        if n5 < 6 :
            ...
            liste_retour.append(liste_matrice_objets[4][5-n5])
            if couleur == "red" :
    ...
    if 500< event.x <600 :
        if n6 < 6 :
            ...
            liste_retour.append(liste_matrice_objets[5][5-n6])
            if couleur == "red" :
    ...
    if 600< event.x <700 :
        if n7 < 6 :
            ...
            liste_retour.append(liste_matrice_objets[6][5-n7])
            if couleur == "red" :
...
def jeu(event):
    ...
    if arret_du_jeu == 0:
        if alternance == True:
            ...
            if couleur == "red":
                couleur = "yellow"
                info_consigne.config(text = "Joeur jaune à vous de jouer.", fg = "yellow", bg = "black")
            else:
                couleur = "red"
                info_consigne.config(text = "Joeur rouge à vous de jouer.", fg = "red", bg = "black")
        ...
        for j in range(6):
            if matrice_jeu[i][j] == matrice_jeu[i][j+1] and matrice_jeu[i][j+1] != 0 :
                ...
                if cpt == 3:
                    arret_du_jeu+=1
                    if couleur == "red" :
                         info_win.config(text = "Le joueur jaune à gagner", fg = "yellow", bg = "black")
                    if couleur == "yellow" :
                        info_win.config(text = "Le joueur rouge à gagner", fg = "red", bg = "black")
            else:
                cpt=0
...
def check_win_diagonale():
    ...
    #diagonale 3 combinaisons
    if (matrice_jeu[5][0] == matrice_jeu[4][1] == matrice_jeu[3][2] == matrice_jeu[2][3] != 0) or (matrice_jeu[4][1] == matrice_jeu[3][2] == matrice_jeu[2][3] == matrice_jeu[1][4] != 0) or (matrice_jeu[3][2] == matrice_jeu[2][3] == matrice_jeu[1][4] == matrice_jeu[0][5] != 0): 
        arret_du_jeu+=1
        if couleur == "red" :
            info_win.config(text = "Le joueur jaune à gagner", fg = "yellow", bg = "black")
        if couleur == "yellow" :
    ...
    #diagonale 3 combinaisons
    if (matrice_jeu[5][1] == matrice_jeu[4][2] == matrice_jeu[3][3] == matrice_jeu[2][4] != 0) or (matrice_jeu[4][2] == matrice_jeu[3][3] == matrice_jeu[2][4] == matrice_jeu[1][5] != 0) or (matrice_jeu[3][3] == matrice_jeu[2][4] == matrice_jeu[1][5] == matrice_jeu[0][6] != 0):
        arret_du_jeu+=1
        if couleur == "red" :
            info_win.config(text = "Le joueur jaune à gagner", fg = "yellow", bg = "black")
        if couleur == "yellow" :
    ...
    #diagonale 1 combinaison
    if (matrice_jeu[3][0] == matrice_jeu[2][1] == matrice_jeu[1][2] == matrice_jeu[0][3] != 0) or (matrice_jeu[5][3] == matrice_jeu[4][4] == matrice_jeu[3][5] == matrice_jeu[2][6] != 0):
        arret_du_jeu+=1
        if couleur == "red" :
            info_win.config(text = "Le joueur jaune à gagner", fg = "yellow", bg = "black")
        if couleur == "yellow" :
    ...
    #diagonale 2 combinaisons
    if (matrice_jeu[4][3] == matrice_jeu[3][4] == matrice_jeu[2][5] == matrice_jeu[1][6] != 0) or (matrice_jeu[5][2] == matrice_jeu[4][3] == matrice_jeu[3][4] == matrice_jeu[2][5] != 0) or (matrice_jeu[4][0] == matrice_jeu[3][1] == matrice_jeu[2][2] == matrice_jeu[1][3] !=0) or (matrice_jeu[3][1] == matrice_jeu[2][2] == matrice_jeu[1][3] == matrice_jeu[0][4] !=0) :
        arret_du_jeu+=1
        if couleur == "red" :
            info_win.config(text = "Le joueur jaune à gagner", fg = "yellow", bg = "black")
        if couleur == "yellow" :
    ...
    #diagonale 3 combinaisons
    if (matrice_jeu[5][6] == matrice_jeu[4][5] == matrice_jeu[3][4] == matrice_jeu[2][3] != 0) or (matrice_jeu[4][5] == matrice_jeu[3][4] == matrice_jeu[2][3] == matrice_jeu[1][2] != 0) or (matrice_jeu[3][4] == matrice_jeu[2][3] == matrice_jeu[1][2] == matrice_jeu[0][1] != 0): 
        arret_du_jeu+=1
        if couleur == "red" :
            info_win.config(text = "Le joueur jaune à gagner", fg = "yellow", bg = "black")
        if couleur == "yellow" :
    ...
    #diagonale 3 combinaisons
    if (matrice_jeu[5][5] == matrice_jeu[4][4] == matrice_jeu[3][3] == matrice_jeu[2][2] != 0) or (matrice_jeu[4][4] == matrice_jeu[3][3] == matrice_jeu[2][2] == matrice_jeu[1][1] != 0) or (matrice_jeu[3][3] == matrice_jeu[2][2] == matrice_jeu[1][1] == matrice_jeu[0][0] != 0):
        arret_du_jeu+=1
        if couleur == "red" :
            info_win.config(text = "Le joueur jaune à gagner", fg = "yellow", bg = "black")
        if couleur == "yellow" :
    ...
    #diagonale 1 combinaison
    if (matrice_jeu[5][3] == matrice_jeu[4][2] == matrice_jeu[3][1] == matrice_jeu[2][0] != 0) or (matrice_jeu[3][6] == matrice_jeu[2][5] == matrice_jeu[1][4] == matrice_jeu[0][3] != 0):
        arret_du_jeu+=1
        if couleur == "red" :
            info_win.config(text = "Le joueur jaune à gagner", fg = "yellow", bg = "black")
        if couleur == "yellow" :
    ...
    #diagonale 2 combinaisons
    if (matrice_jeu[5][4] == matrice_jeu[4][3] == matrice_jeu[3][2] == matrice_jeu[2][1] != 0) or (matrice_jeu[4][3] == matrice_jeu[3][2] == matrice_jeu[2][1] == matrice_jeu[1][0] != 0) or (matrice_jeu[4][5] == matrice_jeu[3][4] == matrice_jeu[2][3] == matrice_jeu[1][2] !=0) or (matrice_jeu[3][4] == matrice_jeu[2][3] == matrice_jeu[1][2] == matrice_jeu[0][1] !=0) :
        arret_du_jeu+=1
        if couleur == "red" :
            info_win.config(text = "Le joueur jaune à gagner", fg = "yellow", bg = "black")
        if couleur == "yellow" :
...
def retour(): # il faut améliorer
     global liste_retour, n1, n2, n3, n4, n5, n6, n7
     canvas.itemconfigure(liste_retour[-1], fill = "white")
     liste_retour.remove(liste_retour[-1])
     print(liste_retour)
...
info_consigne = tk.Label(root,text = "Bienvenue  ce jeu est un puissance4. \n Appuyer sur affichage pour commerncer le jeu.",font = ("helvetica",16),fg = "black")
info_consigne.grid(row = 1,column=1)
